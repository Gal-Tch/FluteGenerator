...
class FluteGenerator:
    def __init__(self):
        ...
        self.hole_size = 0.005  # the holes need to be large enough in order for the open-pipe assumptions to be correct [meters]
    ...
    def design_flute(self,
        ...
        if allow_holes:
            hole_locations = hs.value
            results += hole_locations
        # Printing results
        if allow_holes:
            for i in range(n//2):
